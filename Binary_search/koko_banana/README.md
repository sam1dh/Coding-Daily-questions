...
Initial Setup: Koko needs to eat all these bananas within 8 hours. Our search for the optimal speed starts between 1 (minimum) and 11 (maximum, the largest pile).

piles = [3, 6, 7, 11], h = 8 min_speed = 1, max_speed = 11

Step 1: First guess - speed = 6
